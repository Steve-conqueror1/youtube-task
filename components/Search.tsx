...
const Search: React.FC<Props> = (props) => {
  ...
  return (
    <form
      ...
      className={`flex items-center mx-auto  ${videosAvailable? "w-full" : "w-[686px]"}`}
    >
      <Input
        {...register("search")}
        className={`input-class h-[52px]  focus-visible:ring-0 focus-visible:bg-gray-400 relative`}
        type="text"
   ...
   />
      ...
      >
        {videosAvailable ? (
            <svg className={"absolute left-0 top-1/2 -translate-x-[190%] -translate-y-1/2 cursor-pointer"} width="24" height="21" viewBox="0 0 24 21" fill="none"
          ...
          <path
              ...
              stroke="#F65980" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        ): null}
        Найти
      </Button>
